...
| Brute-force API key | Key guessing | API keys are 32 chars of base62 → ≥190 bits entropy. Postgres can't be probed fast enough; rate-limited at edge. Adversary needs ~2¹⁹⁰ requests. |
